...
export class SpacePermissionsMiddleware extends BaseMiddleware implements Middleware {
  ...
  private async handleMixin (tx: TxCUD<Space>): Promise<void> {
    ...
    const spaceType = await this.context.modelDb.findOne(core.class.SpaceType, { _id: spaceTypeId })
  ...
  private async handlePermissionsUpdatesFromRoleTx (ctx: MeasureContext, tx: TxCUD<Doc>): Promise<void> {
  ...
  private async handlePermissionsUpdatesFromTx (ctx: MeasureContext, tx: TxCUD<Doc>): Promise<void> {
  ...
  private async processPermissionsUpdatesFromTx (ctx: MeasureContext, tx: Tx): Promise<void> {
  ...
  protected async checkPermissions (ctx: MeasureContext, tx: Tx): Promise<void> {
